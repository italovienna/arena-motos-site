      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm mb-6">
            ...
            <span className="text-sm font-medium text-arena-white tracking-wide uppercase">Alta Performance em Motocross</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold font-heading text-arena-white mb-6 leading-tight">
            POTÊNCIA E<br />
            <span className="text-gradient">CONFIANÇA</span> NA<br />
            SUA MÁQUINA
          </h1>
          
          <p className="text-lg md:text-xl text-gray-300 font-sans mb-10 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              ...
              className="inline-flex justify-center items-center px-8 py-4 bg-arena-red hover:bg-arena-red-dark text-white font-bold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-arena-red/30 gap-2 uppercase tracking-wide"
            >
